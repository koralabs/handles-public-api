...
import { IGetAllHoldersQueryParams, IGetHolderAddressDetailsRequest } from '../interfaces/request.interface';
import { HolderPaginationModel, IHandlesRepository } from '@koralabs/kora-labs-common';
