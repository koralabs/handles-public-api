...
describe('CBOR tests', () => {
    describe('Encode/decode Handle JSON and PlutusDataCbor', () => {
        ...
        const expectedCbor =
            '';
    ...
    describe('Encode/decode designer datum', () => {
        const getJson = (): IPersonalizationDesigner => ({
            svg_version: '1.0.0',
            image_hash: '0x4da965a049dfd15ed1ee19fba6e2974a0b79fc416dd1796a1f97f5e1',
            standard_image_hash: '0x4da965a049dfd15ed1ee19fba6e2974a0b79fc416dd1796a1f97f5e1',
        ...
        const cbor =
            '';
    ...
    describe('Encode/decode Standard JSON and PlutusDataCbor', () => {
        ...
        const cbor =
            'a24866697273744b657946737472696e67497365636f6e644b6579a24966697273744c6973748201034322222283a14874686972644b657946323232323232a149666f757274684b657943333333a14866696674684b657900';
    ...
    describe('Encode/decode personalization settings', () => {
        ...
        const pzCbor =
            '';
    ...
    describe('Encode/decode hex colors', () => {
        it('Should encode hex encoded values properly', async () => {
            ...
            expect(encoded).toEqual('a146636f6c6f72738243ffffff43000000');
        });
